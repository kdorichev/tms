%\documentclass[t,14pt]{beamer}  % [t], [c], или [b] --- вертикальное выравнивание на слайдах (верх, центр, низ)
...
\author[Библейская Церковь СПб]{Константин Доричев}

\titlegraphic{\vspace{-1.5cm}\includegraphics[width=5cm]{logo_black_on_transparent_800x800}}
\date{}
